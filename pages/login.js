                ...
                <form className="form-horizontal w-3/4 mx-auto">
                  <div className="flex flex-col ">
                    <input
                      id="email"
                      type="text"
                      className="appearance-none block w-full bg-gray  text-gray-700 rounded-3xl border-2 border-grey-500 py-2 px-4 mb-3 leading-tight  focus:outline-none focus:bg-white"
                      name="email"
                      placeholder="Email"
